...
class USLP_DSP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/Users/lightspark/Documents/BSE/gr-ccsds/USLP/QPSK_Modulated_Signal_Test', False, 0, 0)
        ...
        self.connect((self.blocks_throttle2_0_0, 0), (self.qtgui_time_sink_x_1_0, 0))
